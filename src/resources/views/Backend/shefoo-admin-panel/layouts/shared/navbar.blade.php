            ...
            <ul class="nav navbar-nav flex-row">
                ...
                <li class="nav-item mr-auto">
                    <a class="navbar-brand" href="index.html">
                        <img class="brand-logo" alt="modern admin logo" src="{{shefoo_admin_assets('images/logo/logo.png')}}">
                        <h3 class="brand-text">{{config('shefoo-admin-panel.app_name')}}</h3>
                    </a>
                </li>
        ...
        <div class="navbar-container content">
            <div class="collapse navbar-collapse" id="navbar-mobile">
                        ...
                        <ul class="mega-dropdown-menu dropdown-menu row">
                            <li class="col-md-2">
                                ...
                                <div id="mega-menu-carousel-example">
                                    <div>
                                        <img class="rounded img-fluid mb-1" src="{{shefoo_admin_assets('images/slider/slider-2.png')}}" alt="First slide"><a
                ...
                <span class="mr-1">Hello,
                  ...
                  <img src="{{shefoo_admin_assets('images/portrait/small/avatar-s-19.png')}}" alt="avatar"><i></i></span>
                        </a>
                    ...
                    <li class="dropdown dropdown-notification nav-item">
                        ...
                        <span class="avatar avatar-sm avatar-busy rounded-circle">
                          <img src="{{shefoo_admin_assets('images/portrait/small/avatar-s-2.png')}}" alt="avatar"><i></i></span>
                                        </div>
                                        <div class="media-body">
                                ...
                                <a href="javascript:void(0)">
                                    <div class="media">
                                        <div class="media-left">
                        <span class="avatar avatar-sm avatar-online rounded-circle">
                          <img src="{{shefoo_admin_assets('images/portrait/small/avatar-s-3.png')}}" alt="avatar"><i></i></span>
                                        </div>
                                        <div class="media-body">
                        ...
                        <span class="avatar avatar-sm avatar-away rounded-circle">
                          <img src="{{shefoo_admin_assets('images/portrait/small/avatar-s-6.png')}}" alt="avatar"><i></i></span>
                                        </div>
                                        <div class="media-body">
